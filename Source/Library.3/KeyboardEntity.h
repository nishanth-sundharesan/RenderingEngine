...
namespace Library_3
{
	...
	class KeyboardEntity final : public Library_3::GameEntity
	{
	public:
		KeyboardEntity(Library_3::Game& game);
		~KeyboardEntity() = default; 
		
		KeyboardEntity() = delete;

		KeyboardEntity(const KeyboardEntity&) = delete;
		KeyboardEntity(KeyboardEntity&&) = delete;

		KeyboardEntity& operator=(const KeyboardEntity&) = delete;
		KeyboardEntity& operator=(KeyboardEntity&&) = delete;
